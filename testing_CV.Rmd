...
```{r, echo=FALSE, message=FALSE,warning = FALSE}
library(tidyverse)
pre_prints <- c("Jangraw DC, Keren H, Bedder RL, Rutledge RB, Perreira F, Thomas AG,Pine DS, Zheng C, Nielson, DM , **Stringaris** A (2021) A Highly Replicable Decline in Mood During Rest and Simple Tasks, _Nature Human Behaviour_")
