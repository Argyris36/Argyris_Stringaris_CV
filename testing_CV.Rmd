...
**Professor of Child & Adolescent Psychiatry, University College
London**

[a.stringaris\@ucl.ac.uk](mailto:a.stringaris@ucl.ac.uk){.email}\
1-19 Torrington Pl, London WC1E 7HB, United Kingdom\
my UCL
[website](https://www.ucl.ac.uk/psychiatry/professor-argyris-stringaris)\
AIM lab's [website](https://brainlog.blog/) and
[github](https://github.com/transatlantic-comppsych)\
AIM clinic's
[website](https://www.ucl.ac.uk/university-clinic/about-university-clinic/clinical-services/anxiety-self-image-and-mood-aim-clinic)
...
can be found
[here](https://www.nature.com/articles/s41562-023-01519-7#:~:text=In%20this%20study%2C%20we%20describe,simple%20tasks%20or%20rest%20periods.)
and [here](https://elifesciences.org/articles/62051). Currently we are
funded by the Wellcome Trust to study surprises (prediction errors) as a
mechanism of improvement in social anxiety.
...
[here](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8016742/) and for
some work on interventions, see
[here](https://www.jaacap.org/article/S0890-8567(19)30349-1/fulltext). I
also try to increase awareness of statistics and inferences about public
health through my work, e.g.
[here](https://pubmed.ncbi.nlm.nih.gov/37226639/) and
[here](https://www.nature.com/articles/s44220-024-00208-2).

```{r echo = F, message = F, warning= F}
library(scholar)
```

My h-index = `r get_profile("9B82424AAAAJ")$h_index` and here is a [list
of my
...
-   Entry into the UK Specialist Register for Child and Adolescent
    Psychiatry (CCT): 2011
-   Royal College of Psychiatrists Membership: 813569, Since 2018 a
...
-   Jan 2012 - August 2016 Senior Lecturer Head of Mood and Development
    Laboratory, Department of Child & Adolescent Psychiatry, Institute
...
-   Chair of the Mental Health Committee of the Surgeon General's Office
    ...
    opinion on issues such as the regulation of psychotherapies in
    Greece, and most recently our opinion in favour of banning of
    so-called "conversion therapies", which was eventually enshrined in
    law.

-   Member of the Steering Committee of the University Research
    Institute for Mental Health (EPIPSY) in Greece (January 2022 -
    ongoing)

**Scientific Advisor to Charities**

-   Chief Scientific Officer of Mazi Gia to Paidi, a leading Greek
    charity for children and young people with various activities around
    child health.
...
-   Member of the Executive Board of the Royal College of Psychiatry
    Child and Adolescent Psychiatry Faculty.(2023 - ongoing)
...
-   Member Scientific Advisory Group of Improving Adolescent mentaL
    health by reducing the Impact of PoVErty\
...
-   2024 Editor's Choice Prize for our paper with Dr Foulkes "Do No
    ...
    BJPsych Bulletin.
-   2023 World Top 2% scientist according to Stanford-Elsevier rankings
-   2022 World Top 2% scientist according to Stanford-Elsevier rankings
...
-   Turin Conference on Mood dysregulation and risky behavior in
    adolescents: implications for treatment, Turin University, April
    2024
-   Wolfson Lecture, Fundamental Problems in the Evidence Base for
    Depression. Wolfson Centre at Cardiff University, April 2024
-   Emanuel Miller International Conference 2024, Fundamental Problems
    in the Evidence Base for Youth Depression, Association for Child and
...
-   Keynote Lecture, Symposium on Emotion Dysregulation and Suicide,
    April 2024, University of Torino, Turin, Italy
...
-   Keynote Speaker The Future and Challenges of Child and Adolescent
    Psychiatry at Hellenic Conference of Child and Adolescence
    Psychiatry, Athens, November 2023
...
-   Keynote Speaker ESCAP Conference, Copenhagen, June 2023, Affective
    ...
    Maintained?
-   Keynote Speaker Reading Emotions Conference, June 2023 Fluctuation
    and Change Implications for Neurocognitive Development and
    Psychopathology
...
-   Guest Speaker and Panelist Pediatric Major Depressive Disorder
    ...
    Health and the Division of Psychiatry Office of New Drugs \| Center
    for Drug Evaluation & Research \| U.S. Food and Drug Administration
    (FDA), (June 2022) Bethesda, MD, USA
-   Keynote Lecture (Lettura Magistrale) at the joint meeting of the
    ...
    Psychiatry (May 2022), Cagliari, Italy, Title: What is mood and how
    to modify it
-   Keynote Lecture (Hauptvortrag) at the German Society for Child and
    ...
    gibt es Depression
-   Annual Distinguished Scientist Lecture at Pittsburgh University
    (April 2022) The Why and How of Mood: Theoretical and Computational
...
-   Opening Lecture at the European College of Neuropsychopharmacology
    (ENCP) at\
    Servolo,Venice (March 2022) Challenges and New Directions in
    Affective Nosology
-   Grand Rounds at Cornell University Department of Psychiatry
    (February 2022) What is mood? A conceptual and computational account
    of some basic questions about depression.
...
-   Title: Understanding the role of tonic and phasic irritability in
    developmental psychopathology through an ecologically valid
    multimodal investigation.\
    Position: Collaborator Funding Body: Swiss National Science
    Foundation (grant number is 32003B_215660) Amount:763,934 CHF
    Outcome: awarded April 2023

-   Title: NIHR/HTA 22/88 Repetitive Transcranial Magnetic Stimulation
    for depression in adolescents Position: Co-I and site PI (overall PI
    Dr Rogers, Birmingham)\
    Funding Body: National Institute of Health Research
    Amount:£118,139.74 Outcome: not funded
...
-   Title: Amending and Upgrading Guidance for boosting MENTal health in
    ...
    Funding Body: European Union, Horizon 2020 Amount:£405,104.33
    Outcome: not funded
...
-   Title: Me_Health_e: testing the added value of electronic outcome
...
-   Dr Hanna Keren, Associate Professor with Bar Ilan University at
    Israel
...
-   Mr Jiazhou Chen, August 2020 (initially first then second
    supervisor) - Current
...
**Doctoral Students** I currently supervise two Psychology Doctoral
Students

**MSc Students** I supervise students for the UCL Child and Adolescent
...
-   Lecturer for the UCL Child and Adolescent Mental Health Module of
    MSc Psychiatry course
...
-   Organization of Faculty Retreats. I have been an active member of
    the NIH Faculty Retreat Committee and has so far given talks at
    three out of the four faculty retreats that have happened since my
    arrival at NIMH.
...
-   Sports: I row competitively on Concept 2 and in 2021 I ranked
    ...
    (6:36.8), 97th percentile in 5000 m (17:49.3), and 91st percentile
    in the half marathon (1:21:40.1). In the 2023 season, I raced 5000 m
    17:56.8.

-   Philosophy: I am working on the relevance of the work of Panajotis
    Kondylis, particularly his Macht und Entscheidung, to emotion
    theory, as well as issues related to the conceptual history of mood
    inspired from Reinhart Kosselleck's work on Begriffsgeschichte. Some
    of these results I presented at my keynote at the European Child and
    Adolescent Psychiatry Conference this year.
...
**Stringaris A** (2024) Emotion and Emotional Disorders: A Primer for
Clinicians and Neuroscientists. In Thapar A, Pine D, **Stringaris** A,
Ford T, Cresswell C, Cortese S, Leckman J (in preparation) Rutter’s
Textbook of Child Psychiatry and Psychology, Oxford, UK: Wiley Blackwell

Prabhakar J, Nielson DM, **Stringaris** (2022) Origins of Anhedonia in
Childhood and Adolescence,In Pizzagali D (Ed) Current Topics in
Behavioural Neuroscience. Springer

O’Callaghan, G. & **Stringaris** , A (2019) Reward Processing in
...
Mulraney M, **Stringaris** A, Taylor A (2018). Irritability, disruptive
mood and ADHD. In Oxford Textbook of Attention Deficit Hyperactivity
Disorder. Ed. Banaschewski T, Coghill D, Zuddas A. Oxford University
Press

Krieger FV and **Stringaris** A (2015). Temperament and Vulnerability to
Externalizing Behavior in The Oxford Handbook of Externalizing Spectrum
Disorders, Eds. Beauchaine TP and Hinshaw S. New York:Oxford University
Press.

**Stringaris** A (2015). Emotion regulation and emotional disorders:
...
**Stringaris** AK, Asherson P (2008). Molecular Genetics in Child
Psychiatry in Advances in Biological Child Psychiatry, Eds. Rohde LA,
Banaschewski, T. Basel: Karger Publishing.

Giora R, **Stringaris** AK (2008). Neural Substrates of Metaphors in The
Cambridge Encyclopedia of the Language Sciences (CELS), Ed. Hogan PC.
...
test_pub_med <- read.csv("~/Downloads/csv-stringaris-set (13).csv") # still getting these manually for the moment
...
PubMed[i]<-paste0(i, ". ", test_pub_med$Authors[i], " ", "(", test_pub_med$Publication.Year[i], ")", " ", test_pub_med$Title[i], " ", test_pub_med$Journal.Book[i], " ", "PMID:", test_pub_med$PMID[i])
  }
...
# openxlsx::write.xlsx(PubMed, "PubMed.xlsx")
```
